...
module.exports = (req, res, next) ->
    ...
    isNoAuthRoute = isNoAuthRoute and req.url.indexOf("/services/sharing/request") isnt 0
    isNoAuthRoute = isNoAuthRoute and req.url.indexOf("/services/sharing/cancel") isnt 0
